    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            final StringBuilder logMessage = new StringBuilder("REST Request - ")
                    ...
                    .append("] [HTTP URI:").append(httpServletRequest.getRequestURI())
                    .append("] [PATH INFO:").append(httpServletRequest.getPathInfo())
                    .append("] [REQUEST PARAMETERS:").append(requestMap)
                    .append("] [REQUEST BODY:").append(bufferedReqest.getRequestBody()) //리퀘스트 Body값 출력
