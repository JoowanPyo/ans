    ...
    private void initialize()throws ConfigurationException{
        ...
        if (configUrl == null) {
            ...
            /*File defaultFile = new File(System.getProperty("file.separator"), File.separator+"data"+File.separator+"app"
                    +File.separator+"ans"+File.separator+"server"+File.separator+"config"+File.separator+"config.properties");*/
            File defaultFile = new File("/data/app/ans/server/config/config.properties");
        ...
        try
        {
            ...
            /*if (fileName != null && !"".equals(fileName)){
                fileName = fileName.replaceAll("/", File.separator); // "/" 필터링
                fileName = fileName.replaceAll("\\\\", File.separator); // "\" 필터링
                fileName = fileName.replaceAll("\\.\\.", File.separator); // ".." 필터링
            }*/

            File configFile = new File("/data/app/ans/server/config/config.properties");
