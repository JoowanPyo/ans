...
public class CueSheetHistController {
    ...
    @GetMapping(path = "")
    public AnsApiResponse<List<CueSheetHistDTO>> findAll(@Parameter(name = "cueId", description = "큐시트 아이디")
