...
public class ArticleController {
    ...
    public ApiResponse<List<ArticleDTO>> findAll(
        ...
        List<ArticleDTO> articleDTOList = articleService.findAll(searchDate.getStartDate(), searchDate.getEndDate(), rcvDt, rptrId, brdcPgmId, artclDivCd, artclTypCd, searchDivCd, searchWord);
