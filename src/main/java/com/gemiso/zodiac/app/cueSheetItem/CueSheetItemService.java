...
public class CueSheetItemService {
    ...
    public void createCueTemplate(Long cueId, List<CueSheetItemCreateTmplDTO> cueSheetItemCreateTmplDTO, String cueItemDivCd, String spareYn, String userId) throws Exception {
        ...
        cueSheetTopicService.sendCueTopicCreate(cueSheet, cueId, null, null, null, "Create CueSheetItem Form Template",
                spareYn, "N", "N");
    ...
    public CueSheetItem copyTmpltItem(CueTmpltItem cueTmpltItem, Long cueId, String userId, String spareYn) {
        ...
        if ("Y".equals(spareYn)) {
            cueSheetItemEntity = CueSheetItem.builder()
                    ...
                    .inputrId(userId)
                    .spareYn(spareYn)
                    .artclExtTime(cueTmpltItem.getArtclExtTime())
                    .cueSheet(cueSheet)
    ...
    public CueSheetItem copyItem(Long cueId, CueSheetItem cueSheetItem, Article article, CueSheetTemplate cueSheetTemplate, String userId, String spareYn) {
        ...
        if ("Y".equals(spareYn)) {
            cueSheetItemEntity = CueSheetItem.builder()
                    ...
                    .spareYn(spareYn)
                    .artclExtTime(cueSheetItem.getArtclExtTime())
                    .cueSheet(cueSheet)
                    .article(article)
    ...
    public void createTemplate(List<CueSheetItemCreateDTO> cueSheetItemCreateDTOList, Long cueId, String userId) throws Exception {
        ...
        for (CueSheetItemCreateDTO cueSheetItemCreateDTO : cueSheetItemCreateDTOList) {
            ...
            spareYn = cueSheetItem.getSpareYn();
            ordUpdateDrop(cueSheetItem, cueId, cueItemOrd, spareYn); //큐시트 순번 정렬
        }
   ...
   /* //큐시트 토픽 메세지 전송
    ...
    public CueSheetItemMediaListDTO findAllMedia(Long cueId) {
        ...
        List<CueSheetMediaDTO> cueSheetMediaDTOList = cueSheetMediaMapper.toDtoList(cueSheetMediaList);
        List<ArticleMediaDTO> articleMediaDTOList = articleMediaMapper.toDtoList(articleMediaList);

        CueSheetItemMediaListDTO cueSheetItemMediaListDTO = new CueSheetItemMediaListDTO();
        cueSheetItemMediaListDTO.setCueSheetMediaDTO(cueSheetMediaDTOList);
        cueSheetItemMediaListDTO.setArticleMediaDTO(articleMediaDTOList);


        return cueSheetItemMediaListDTO;
