...
public interface BaseProgramRepository extends JpaRepository<BaseProgram, Long>, QuerydslPredicateExecutor<BaseProgram> {
    ...
    @Query("select a from BaseProgram a left outer join Program b on b.brdcPgmId = a.program.brdcPgmId " +
            "where a.program.brdcPgmId = :brdcPgmId and a.brdcStartClk =:formatBoradHm ")
